...
const reducer = (
  ...
  switch (action.type) {
    ...
    case REDUCER_ACTION_TYPES.QUANTITY: {
      ...
      if (!itemExists) {
        throw new Error('Item must exist in order to update the quatity.');
      }
...
const useCartContext = (initCartState: CartStateType) => {
  ...
  const totatItems: number = state.cart.reduce((prev, item) => {
  ...
  return { dispatch, REDUCER_ACTIONS, cart, totalPrice, totatItems };
};
